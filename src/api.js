...
app.use('/.netlify/functions/api',server_route);
app.use('/.netlify/functions/api',ad_route);
app.use('/.netlify/functions/api',Comment_route);
app.use('/.netlify/functions/api',Message_route);
